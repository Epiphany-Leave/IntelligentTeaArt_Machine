...
void Gui_Drawbmp16_Flexible(u16 x, u16 y, const unsigned char *p, u16 width, u16 height)
{
    ...
    // 设置显示窗口，确保不会越界
    u16 maxX = (x + width - 1) > 128 ? 128 : (x + width - 1);  // 右边界不超过128
    u16 maxY = (y + height - 1) > 160 ? 160 : (y + height - 1); // 下边界不超过160
    LCD_SetWindows(x, y, maxX, maxY);

    // 遍历每个像素并显示
    for(i = 0; i < height; i++)  // 遍历图片的高度
    {
        for(j = 0; j < width; j++)  // 遍历图片的宽度
        {
            // 获取图片数据（16位色彩格式，每个像素2字节）
            picL = *(p + (i * width + j) * 2);          // 低字节
            picH = *(p + (i * width + j) * 2 + 1);      // 高字节
...
Gui_StrCenter(0,lcddev.height-18,WHITE,BLUE,"Tea boiling",16,1);//居中显示
//绘制测试区域
//LCD_Fill(0,20,lcddev.width,lcddev.height-20,WHITE);
}

/*****************************************************************************
 * @name       :void lcd_main_test(void)
 * @date       :2018-08-09 
...
{
	DrawTestPage("煮茶机");
    Gui_Drawbmp16_Flexible(0, 20, gImage_main, 128, 104);
}

void my_testB1(void)
{
	DrawTestPage("选项");
	Show_Str(10, 20, BLUE, LGRAYBLUE, "倒水", 16, 0);
	Show_Str(10, 20+30*1, BLUE, LGRAYBLUE, "煮茶", 16, 1);
	Show_Str(10, 20+30*2, BLUE, LGRAYBLUE, "沏茶", 16, 1);	
	Show_Str(10, 20+30*3, BLUE, LGRAYBLUE, "EXIT", 16, 1);
}
void my_testB2(void)
{
	DrawTestPage("选项");
	Show_Str(10, 20, BLUE, LGRAYBLUE, "倒水", 16, 1);
	Show_Str(10, 20+30*1, BLUE, LGRAYBLUE, "煮茶", 16, 0);
	Show_Str(10, 20+30*2, BLUE, LGRAYBLUE, "沏茶", 16, 1);	
	Show_Str(10, 20+30*3, BLUE, LGRAYBLUE, "EXIT", 16, 1);
}
void my_testB3(void)
{
	...
	Show_Str(10, 20, BLUE, LGRAYBLUE, "倒水", 16, 1);
	Show_Str(10, 20+30*1, BLUE, LGRAYBLUE, "煮茶", 16, 1);
	Show_Str(10, 20+30*2, BLUE, LGRAYBLUE, "沏茶", 16, 0);	
	Show_Str(10, 20+30*3, BLUE, LGRAYBLUE, "EXIT", 16, 1);
}
void my_testB4(void)
{
	...
	Show_Str(10, 20+30*1, BLUE, LGRAYBLUE, "煮茶", 16, 1);
	Show_Str(10, 20+30*2, BLUE, LGRAYBLUE, "沏茶", 16, 1);	
	Show_Str(10, 20+30*3, BLUE, LGRAYBLUE, "EXIT", 16, 0);
}
